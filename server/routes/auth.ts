...
router.put('/profile', authenticateToken, (req: AuthenticatedRequest, res: Response): void => {
  try {
    ...
    const updates: Partial<VolunteerProfile> = {
      ...
      banner_color: banner_color !== undefined ? banner_color : req.profile.banner_color,
      banner_image_url: banner_image_url !== undefined ? banner_image_url : req.profile.banner_image_url,
      avatar_decoration: avatar_decoration !== undefined ? avatar_decoration : req.profile.avatar_decoration,
      profile_effect: profile_effect !== undefined ? profile_effect : req.profile.profile_effect,
      accent_color: accent_color !== undefined ? accent_color : req.profile.accent_color,
      custom_status: custom_status !== undefined ? custom_status.trim() : req.profile.custom_status,
      custom_status_emoji: custom_status_emoji !== undefined ? custom_status_emoji.trim() : req.profile.custom_status_emoji,
      pronouns: pronouns !== undefined ? pronouns.trim() : req.profile.pronouns,
