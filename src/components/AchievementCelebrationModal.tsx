...
export const AchievementCelebrationModal: React.FC<AchievementCelebrationModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-3 sm:p-6 bg-black/85 backdrop-blur-xl animate-fadeIn">
      {/* Container Card */}
      <div className="relative w-full max-w-lg bg-gradient-to-b from-[#0B1728] via-[#07111F] to-[#040810] border border-amber-500/40 rounded-3xl p-6 sm:p-8 text-center shadow-[0_0_90px_rgba(245,158,11,0.25)] overflow-hidden flex flex-col items-center">
        {/* Background Rotating Golden Aura - Softly Diffused with Radial Fade */}
        <div
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[520px] h-[520px] bg-[conic-gradient(from_0deg,transparent_0deg,#F59E0B20_20deg,transparent_45deg,#F59E0B25_70deg,transparent_95deg,#F59E0B20_120deg,transparent_145deg,#F59E0B25_170deg,transparent_195deg,#F59E0B20_220deg,transparent_245deg,#F59E0B25_270deg,transparent_295deg,#F59E0B20_320deg,transparent_345deg,#F59E0B20_360deg)] rounded-full animate-gold-rays pointer-events-none opacity-90 [mask-image:radial-gradient(circle_at_center,black_25%,rgba(0,0,0,0.5)_45%,transparent_70%)]"
        />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-amber-500/15 blur-[90px] rounded-full pointer-events-none [mask-image:radial-gradient(circle_at_center,black_30%,transparent_75%)]" />
