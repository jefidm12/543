...
export interface VolunteerProfile {
  ...
  banner_color?: string; // e.g. '#1e293b' or gradient
  banner_image_url?: string;
  accent_color?: string; // e.g. '#5865F2'
  custom_status?: string; // e.g. "🌳 Sirviendo en ferias BFL"
  custom_status_emoji?: string; // e.g. "✨"
  pronouns?: string; // e.g. "he/him" | "ella/she"
  avatar_decoration?: string;
  profile_effect?: string; // e.g. "hydro_blast", "sakura_petals", "golden_rays", etc.
  created_at: string;
  updated_at: string;
  stats?: {
    approved_minutes: number;
...
export interface LiveCommunityStats {
  total_approved_minutes: number;
