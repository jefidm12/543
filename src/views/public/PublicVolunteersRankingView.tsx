...
export const PublicVolunteersRankingView: React.FC<PublicVolunteersRankingViewProps> = ({
  ...
  const getVolunteerBadges = (vol: PublicVolunteerDetail) => {
    const statsObj = {
      ...
      volunteerSchool: vol.school || '',
      attendedSchools: vol.school ? [vol.school] : [],
      activityCategories: [],
      activityNames: [],
    };
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 space-y-12 animate-fadeIn pb-24">
            ...
            <div className="order-2 md:order-1 flex flex-col justify-end">
              {rank2 ? (
                <div
                  ...
                  className="bg-gradient-to-b from-[#0B192E] via-[#07111F] to-[#0A1628] border-2 border-slate-400/50 rounded-3xl p-6 text-center shadow-xl space-y-4 hover:border-slate-300 transition-all cursor-pointer group relative overflow-hidden"
                >
                  <div className="absolute top-6 left-1/2 -translate-x-1/2 w-32 h-32 bg-slate-400/15 rounded-full blur-2xl pointer-events-none" />

                  {/* Medal badge & icon */}
                  <div className="relative mx-auto w-16 h-16 flex items-center justify-center">
                    <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-slate-200 via-slate-300 to-slate-500 flex items-center justify-center text-slate-950 font-black text-xl shadow-lg shadow-slate-400/20 ring-4 ring-slate-400/30">
                  ...
                  <div className="pt-2">
                    <div className="w-full h-16 rounded-2xl bg-gradient-to-b from-slate-700/80 to-slate-900 border border-slate-400/40 flex items-center justify-center shadow-inner">
                ...
                <div className="bg-[#07111F]/60 border-2 border-dashed border-slate-600/40 rounded-3xl p-6 text-center space-y-4 relative">
                  ...
                  <div className="w-full h-16 rounded-2xl bg-slate-900/60 border border-slate-800 flex items-center justify-center">
            ...
            <div className="order-1 md:order-2 flex flex-col justify-end">
              {rank1 ? (
                <div
                  ...
                  className="bg-gradient-to-b from-amber-950/50 via-[#07111F] to-[#0A1628] border-2 border-amber-400 rounded-3xl p-7 text-center shadow-[0_0_40px_rgba(245,158,11,0.25)] space-y-5 hover:border-amber-300 transition-all cursor-pointer group relative overflow-hidden"
                >
                  {/* Radiant centered gold halo positioned directly behind the crown icon */}
                  <div className="absolute top-6 left-1/2 -translate-x-1/2 w-40 h-40 bg-amber-400/20 rounded-full blur-2xl pointer-events-none" />

                  {/* Crown champion badge with glowing backlight */}
                  <div className="relative mx-auto w-20 h-20 flex items-center justify-center">
                    <div className="absolute -inset-1.5 rounded-3xl bg-gradient-to-tr from-amber-400 to-yellow-300 opacity-40 blur-md" />
                    <div className="relative w-20 h-20 rounded-3xl bg-gradient-to-br from-amber-300 via-yellow-400 to-amber-600 flex items-center justify-center text-slate-950 font-black text-3xl shadow-xl shadow-amber-500/40 ring-4 ring-amber-300/60">
                      <Crown size={38} className="text-slate-950 drop-shadow-sm" />
                    </div>
                  </div>
                  ...
                  <div className="pt-2">
                    <div className="w-full h-24 rounded-2xl bg-gradient-to-b from-amber-500/90 via-yellow-600 to-amber-800 border-2 border-amber-400 flex flex-col items-center justify-center shadow-2xl">
                ...
                /* Empty Gold Slot */
                <div className="bg-[#07111F]/60 border-2 border-dashed border-amber-500/40 rounded-3xl p-7 text-center space-y-4 relative">
                  ...
                  <div className="w-full h-24 rounded-2xl bg-slate-900/60 border border-amber-500/30 flex items-center justify-center">
            ...
            <div className="order-3 flex flex-col justify-end">
              {rank3 ? (
                <div
                  ...
                  className="bg-gradient-to-b from-[#0B192E] via-[#07111F] to-[#0A1628] border-2 border-amber-700/50 rounded-3xl p-6 text-center shadow-xl space-y-4 hover:border-amber-600 transition-all cursor-pointer group relative overflow-hidden"
                >
                  <div className="absolute top-6 left-1/2 -translate-x-1/2 w-32 h-32 bg-amber-700/15 rounded-full blur-2xl pointer-events-none" />

                  {/* Medal badge & icon */}
                  <div className="relative mx-auto w-16 h-16 flex items-center justify-center">
                    <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-amber-600 via-orange-700 to-amber-900 flex items-center justify-center text-white font-black text-xl shadow-lg shadow-amber-800/20 ring-4 ring-amber-600/30">
                  ...
                  <div className="pt-2">
                    <div className="w-full h-12 rounded-2xl bg-gradient-to-b from-amber-800/80 to-amber-950 border border-amber-600/40 flex items-center justify-center shadow-inner">
                ...
                <div className="bg-[#07111F]/60 border-2 border-dashed border-amber-800/40 rounded-3xl p-6 text-center space-y-4 relative">
                  ...
                  <div className="w-full h-12 rounded-2xl bg-slate-900/60 border border-slate-800 flex items-center justify-center">
      ...
      {selectedVolunteer && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-5 bg-black/85 backdrop-blur-md animate-fadeIn overflow-y-auto">
          <div className="bg-[#07111F] border border-sky-500/40 rounded-3xl w-full max-w-3xl shadow-2xl overflow-hidden flex flex-col max-h-[94vh] my-auto">
            {/* Modal Top Bar */}
            <div className="px-6 py-3.5 border-b border-white/10 bg-[#0A1628] flex items-center justify-between gap-4">
              <div className="flex items-center gap-2">
                <span className="px-2.5 py-0.5 rounded-full bg-amber-500/20 text-amber-300 border border-amber-500/30 text-[11px] font-black">
                  RANKING #{selectedVolunteer.rank}
                </span>
                <span className="text-xs text-slate-300 font-bold hidden sm:inline">
                  Perfil de Voluntario Distrital
                </span>
              </div>
            ...
            <div className="p-4 sm:p-6 overflow-y-auto space-y-6">
              {/* Full Interactive Volunteer Profile Card with Live Active Effects, Banner, Avatar & Badges */}
              <VolunteerProfileCard
                profile={selectedVolunteer}
                stats={{
                  approved_minutes: selectedVolunteer.approved_minutes,
                  approved_hours: selectedVolunteer.approved_hours,
                  total_submissions: selectedVolunteer.total_submissions,
                }}
                isEditable={false}
              />
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="text-[10px] text-slate-500 text-right font-mono">
                            {formatDateMMDDYYYY(rev.created_at)}
                          </div>
                        </div>
                      );
                    })
